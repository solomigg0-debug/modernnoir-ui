--[[
╔══════════════════════════════════════════════════╗
║        MODERN NOIR UI LIBRARY  v4.2              ║
║        Tema: Detetive Moderno                    ║
╠══════════════════════════════════════════════════╣
║  FIXES v4.1                                      ║
║  [1] RenderStepped desconectado no Destroy()     ║
║  [2] UIStroke no knob do slider não acumula      ║
║  [3] InputEnded global desconectado por slider   ║
║  [4] Notify: layout fixo, sem AutomaticSize+Y%   ║
║  [5] Slider: um único hitbox, hover correto      ║
║  [6] Brand da sidebar fora do UIListLayout       ║
╠══════════════════════════════════════════════════╣
║  FIXES v4.2                                      ║
║  [7] card.Parent = ng agora explícito no Notify  ║
║  [8] Slider: respeita ranges float (não só int)  ║
║  [9] sbScroll.ClipsDescendants=true (indicator)  ║
╚══════════════════════════════════════════════════╝
--]]

...
:GetState() e :SetState(novoEstado, silent)
...
-- O objeto retornado tem:
:GetValue() e :SetValue(novoValor, silent)
...
-- O objeto retornado tem:
:GetKey() e :SetKey(novaTecla, silent)
...
-- O objeto retornado tem:
:GetColor() e :SetColor(novaCor, silent)
...
Main:AddToggle("Ativar ESP", true, function(v)
    ...
end)

Main:AddSlider("Distância", 0, 500, 100, function(v)
    ...
end)

Main:AddButton("Executar Ação", function()
    ...
end)
